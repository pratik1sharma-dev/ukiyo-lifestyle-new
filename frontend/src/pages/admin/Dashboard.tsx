        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              ...
              <p className="text-gray-600">Manage your inventory and categories</p>
            </div>
          ...
          <div className="bg-white rounded-lg shadow-sm">
            ...
            <div className="p-6">
              <div className="space-y-4">
                ...
                <Link
                  to="/admin/products?status=low-stock"
                  className="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-3">
                      <h3 className="text-sm font-medium text-blue-800">
                        Current Categories: {stats?.totalCategories || 0}
                      </h3>
                      <p className="text-sm text-blue-700 mt-1">
                        Well-organized categories help customers find products easily
                      </p>
                    </div>
                  </div>
                </div>
